...
function AboutUs() {
  const styles = {
    ...
    heroSection: {
      background: "linear-gradient(135deg, #641299 0%, #8b5cf6 100%)",
      borderRadius: "24px",
      padding: "4rem 3rem",
      textAlign: "center",
      color: "white",
          ...
          {[
            {
              ...
              description:
                'Chargily was born from a simple question: "Why should payments be complicated?" We set out to change that!',
            },
            {
              year: "2016",
              title: "First Steps into the World 👶",
              description:
                "Launched our first platform with basic payment services. Small steps, big dreams!",
            },
            {
              year: "2019",
              title: "Going Pro! 💼",
              description:
                "Introduced business solutions and API services. Developers started falling in love with our tools!",
            },
            {
              year: "2022",
              title: "Hardware Heroes 🦸‍♂️",
              description:
                "Expanded into hardware solutions. Now we were everywhere - online AND offline!",
            },
          ].map((item, index) => (
            <div
              key={index}
