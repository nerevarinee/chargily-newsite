        ...
        <div className="footer-top">
          ...
          <div className="footer-download-section">
            ...
            <div className="footer-download-buttons">
              <a href="https://app.chargily.com/" className="download-btn-wa">
                Web App
              </a>
              <a
                href="https://apps.apple.com/us/app/chargily-%D8%B4%D8%A7%D8%B1%D8%AC%D9%8A%D9%84%D9%8A/id6444597019"
              ...
              <a
                href="https://play.google.com/store/apps/details?id=app.chargily.dz&pli=1"
                className="download-btn"
              >
                <svg
                  width="24"
        ...
        <div className="footer-bottom">
          ...
          <div className="footer-brand">
            ...
            <div className="footer-social">
              <a
                href="https://www.facebook.com/Chargily/"
              ...
              <a
                href="https://www.linkedin.com/company/chargily/"
                className="social-link"
                aria-label="LinkedIn"
              >
                <svg
              ...
              <a
                href="https://www.instagram.com/Chargily/"
                className="social-link"
